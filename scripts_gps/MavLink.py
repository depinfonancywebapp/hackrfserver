...
/dev/ttyUSB0 or 0.0.0.0:14550. Auto-detect serial if not given.')
    ...
    while True:
        try: 
            altitude = mav_serialport.mav.messages['GPS_RAW_INT']  # Note, you can access message fields as attributes!
            timestamp = mav_serialport.mav.time_since('GPS_RAW_INT')
            if pos != [altitude.lat/10000000, altitude.lon/10000000]:
                print([altitude.lat/10000000, altitude.lon/10000000])
            pos = [altitude.lat/10000000, altitude.lon/10000000]
