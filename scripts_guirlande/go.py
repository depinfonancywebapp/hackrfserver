...
class go(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "go")
        ...
        self.soapy_hackrf_source_0.set_gain(0, 'VGA', min(max(38, 0.0), 62.0))
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, os.getcwd() + '/hey', False)
...
def main(freq1, top_block_cls=go, options=None):
    global freq
    freq = int(freq1)
